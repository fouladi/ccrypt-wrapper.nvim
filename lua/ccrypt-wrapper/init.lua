...
-- Function to encrypt file content using "ccrypt" with a password
M.encrypt_file = function()
    if not is_ccrypt_installed() then
        print("Error: ccrypt is not installed.")
        return
    end
...
-- Function to decrypt file content using "ccrypt" with a password
M.decrypt_file = function()
    if not is_ccrypt_installed() then
        print("Error: ccrypt is not installed.")
        return
    end
...
M.setup = function()
    ...
    vim.api.nvim_command('command! EncryptFile lua require("ccrypt-wrapper").encrypt_file()')
    vim.api.nvim_command('command! DecryptFile lua require("ccrypt-wrapper").decrypt_file()')
end
